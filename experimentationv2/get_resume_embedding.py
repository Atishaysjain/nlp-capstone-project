...
if __name__ == "__main__":
    ...
    df_resume = pd.read_csv('./resume/structured_resumes.csv')
    ...
    for model in models:
       ...
       'education', 'interest', 'projects', 'certifications', 'publications']
        ...
        output_dir = os.path.join(os.getcwd(), "resume_embeddings")

        df.to_csv(os.path.join(output_dir, model_to_varname(model) + ".csv"), index=False)
